...
const setupUserListener = () => {
  ...
  return onSnapshot(userDocRef, (doc) => {
    if (doc.exists()) {
      ...
      userStore.setUser(userData) // Update the store
    }
  }, (error) => {
...
onMounted(async () => {
  unsubscribeUserListener = setupUserListener()
  ...
  setInterval(checkWeatherForecastForAlerts, 24 * 60 * 60 * 1000); // Every 3 hours
