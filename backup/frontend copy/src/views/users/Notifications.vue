      ...
      <div class="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden border border-gray-200">
          ...
          <div class="space-y-6">
            ...
            <div>
              <div class="flex items-start justify-between mb-3">
                <h3 class="text-xl font-semibold text-gray-900">{{ selectedNotification.title }}</h3>
            ...
            <div class="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 rounded-2xl p-5 border-2 border-indigo-100 shadow-lg">
              ...
              <div v-if="isWeatherNotification(selectedNotification)" class="space-y-5">
                <p class="text-sm text-gray-600 mb-4 bg-white/70 rounded-lg p-3 border border-indigo-200">
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <div class="bg-blue-50 rounded-xl p-4 border-2 border-blue-200 shadow-sm">
                    <div class="flex items-center space-x-2 mb-2">
                      ...
                      <span class="text-sm font-medium text-blue-700">Humidity</span>
                    </div>
                    <p class="text-xl font-bold text-blue-800">{{ selectedNotification.context?.current?.humidity || '--' }}%</p>
                  ...
                  <div class="bg-gray-50 rounded-xl p-4 border-2 border-gray-200 shadow-sm">
                    ...
                    <p class="text-xl font-bold text-gray-800">{{ selectedNotification.context?.current?.pressure || '--' }} hPa</p>
                  ...
                  <div class="bg-green-50 rounded-xl p-4 border-2 border-green-200 shadow-sm">
                    ...
                    <p class="text-xl font-bold text-green-800">{{ selectedNotification.context?.current?.windSpeed || '--' }} km/h</p>
                  ...
                  <div class="bg-yellow-50 rounded-xl p-4 border-2 border-yellow-200 shadow-sm">
                    <div class="flex items-center space-x-2 mb-2">
                      ...
                      <span class="text-sm font-medium text-yellow-700">UV Index</span>
                    </div>
                    <p class="text-xl font-bold text-yellow-800">{{ selectedNotification.context?.current?.uvIndex ? selectedNotification.context.current.uvIndex.toFixed(1) : '--' }}</p>
                ...
                <div v-if="selectedNotification.context?.forecast" class="bg-purple-100 rounded-xl p-4 border-2 border-purple-300 shadow-sm">
                  ...
                  <div class="grid grid-cols-2 gap-4 mt-3">
                    <div class="bg-white/60 rounded-lg p-3">
                      <p class="text-sm text-purple-600 font-medium">Max Temperature</p>
                      <p class="text-lg font-bold text-purple-800">{{ selectedNotification.context.forecast.temperature_max }}°C</p>
                    </div>
                    <div class="bg-white/60 rounded-lg p-3">
                      <p class="text-sm text-purple-600 font-medium">Min Temperature</p>
                      <p class="text-lg font-bold text-purple-800">{{ selectedNotification.context.forecast.temperature_min }}°C</p>
                    </div>
                  </div>
                </div>
              ...
              <div v-else-if="isSensorNotification(selectedNotification)" class="space-y-5">
                ...
                <div v-if="selectedNotification.context?.waterLevel !== undefined" class="bg-cyan-100 rounded-xl p-4 border-2 border-cyan-300 shadow-sm">
                  <div class="flex items-center justify-between mb-3">
                    ...
                    <span class="text-lg font-bold text-cyan-800">{{ selectedNotification.context.waterLevel }}%</span>
                  </div>
                  <p class="text-sm text-cyan-700">{{ getWaterLevelDescription(selectedNotification.context.waterLevel) }}</p>
                </div>
                ...
                <div class="grid grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <div v-if="getSensorValue(selectedNotification, 'soilMoisture') !== null" class="bg-amber-50 rounded-xl p-4 border-2 border-amber-200 shadow-sm">
                    <div class="flex items-center space-x-2 mb-2">
                      ...
                      <span class="text-sm font-medium text-amber-700">Soil Moisture</span>
                    </div>
                    <p class="text-xl font-bold text-amber-800">{{ getSensorValue(selectedNotification, 'soilMoisture') }}%</p>
                  ...
                  <div v-if="getSensorValue(selectedNotification, 'temperature') !== null" class="bg-red-50 rounded-xl p-4 border-2 border-red-200 shadow-sm">
                    ...
                    <p class="text-xl font-bold text-red-800">{{ getSensorValue(selectedNotification, 'temperature') }}°C</p>
                  ...
                  <div v-if="getSensorValue(selectedNotification, 'humidity') !== null" class="bg-blue-50 rounded-xl p-4 border-2 border-blue-200 shadow-sm">
                    ...
                    <p class="text-xl font-bold text-blue-800">{{ getSensorValue(selectedNotification, 'humidity') }}%</p>
                  ...
                  <div v-if="getSensorValue(selectedNotification, 'soilPh') !== null" class="bg-purple-50 rounded-xl p-4 border-2 border-purple-200 shadow-sm">
                    <div class="flex items-center space-x-2 mb-2">
                      ...
                      <span class="text-sm font-medium text-purple-700">Soil pH</span>
                    </div>
                    <p class="text-xl font-bold text-purple-800">{{ getSensorValue(selectedNotification, 'soilPh') }}</p>
                  ...
                  <div v-if="getSensorValue(selectedNotification, 'phosphorus') !== null" class="bg-orange-50 rounded-xl p-4 border-2 border-orange-200 shadow-sm">
                    <div class="flex items-center space-x-2 mb-2">
                      ...
                      <span class="text-sm font-medium text-orange-700">Phosphorus (P)</span>
                    </div>
                    <p class="text-xl font-bold text-orange-800">{{ getSensorValue(selectedNotification, 'phosphorus') }} ppm</p>
                  ...
                  <div v-if="getSensorValue(selectedNotification, 'potassium') !== null" class="bg-yellow-50 rounded-xl p-4 border-2 border-yellow-200 shadow-sm">
                    <div class="flex items-center space-x-2 mb-2">
                      ...
                      <span class="text-sm font-medium text-yellow-700">Potassium (K)</span>
                    </div>
                    <p class="text-xl font-bold text-yellow-800">{{ getSensorValue(selectedNotification, 'potassium') }} ppm</p>
              ...
              <div v-else class="space-y-4">
                <p class="text-sm text-gray-600 bg-white/70 rounded-lg p-3 border border-indigo-200">
                  {{ selectedNotification.context?.additionalInfo || getDynamicAdditionalInfo(selectedNotification) }}
                </p>
                <div class="bg-blue-50 rounded-xl p-4 border-2 border-blue-200 shadow-sm">
                  <div class="flex items-center space-x-2 mb-2">
                    <Info class="h-4 w-4 text-blue-600" />
                    <span class="text-sm font-semibold text-blue-700">Status Information</span>
                  </div>
        ...
        <div class="px-6 py-4 border-t border-gray-100 bg-gray-50 flex items-center justify-end space-x-3">
          ...
          <button 
            ...
            class="flex items-center px-4 py-2 bg-blue-500 text-white rounded-lg text-sm font-medium shadow-sm transition-colors duration-200 hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <button 
            ...
            class="flex items-center px-4 py-2 bg-orange-500 text-white rounded-lg text-sm font-medium shadow-sm transition-colors duration-200 hover:bg-orange-600 disabled:opacity-50 disabled:cursor-not-allowed"
          >
